...
> = {
  en: {
    ...
    feed: {
      ...
      statusDescription:
        "Automatic feed from global coverage. Cards are organized by latest publication time and scroll continuously in both directions.",
      ...
      secondaryNotificationLabel: "Downward live stream",
  ...
  no: {
    ...
    feed: {
      ...
      statusDescription:
        "Automatisk feed fra global dekning. Kortene er sortert etter publiseringstid og ruller kontinuerlig i begge retninger.",
      ...
      secondaryNotificationLabel: "Direktestrøm nedover",
  ...
  ar: {
    ...
    feed: {
      ...
      statusDescription:
        "تغذية تلقائية من التغطية العالمية. البطاقات مرتبة حسب توقيت النشر وتتحرك بشكل مستمر في الاتجاهين.",
      ...
      secondaryNotificationLabel: "تدفق مباشر للأسفل",
